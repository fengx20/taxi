<%@ page language="java" import="java.util.*,java.util.List,com.wzxy.aroundtaxi.pojo.Car" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%
...
<body>
 <!-- 顶部开始 -->
   ...
   @SuppressWarnings("unchecked")
    List<Car>list=(List)request.getAttribute("list"); // 取request里面的对象队列
    if(list.size()!=0){
      for(int i=0;i<list.size();i++){
      Car car=new Car(); //新建对象
      car=list.get(i);   //每循环一次后将此时的值保存到对象里
                %>
